        ...
        protected override async ETTask Run(EventType.PhysXActorCreate args)
        {
            ...
            switch (bodyType)
            {
                ...
                case BodyType.Sphere:
                    ...
                    break;
                case BodyType.Bump:
                    ResourcesComponent.Instance.LoadBundle("PhysXActorBump.unity3d");
                    prefab = (GameObject)ResourcesComponent.Instance.GetAsset("PhysXActorBump.unity3d", "PhysXActorBump");
                    go = UnityEngine.Object.Instantiate(prefab);
